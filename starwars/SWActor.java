...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	/** An int variable that represents the amount of force the actor has*/
	...
	// Constructor function for Droids (Indicates an owner)
	public SWActor(Team team, int hitpoints, MessageRenderer m, SWWorld world, SWActor owner) {
		super(m);
		actions = new HashSet<SWActionInterface>();
		this.team = team;
		this.hitpoints = hitpoints;
		...
		// Owner property is only for Droids
		this.owner = owner;
	...
	// Constructor function for Characters who has Force abilities
	public SWActor(Team team, int hitpoints, MessageRenderer m, SWWorld world, int forcePoints) {
		super(m);
		actions = new HashSet<SWActionInterface>();
		this.team = team;
		this.hitpoints = hitpoints;
	...
	// Function for getting amount of Force points
	public int getForcePoints() {
		return this.forcePoints;
	}
	
	
	// Function for modifying Force points
	public void setForcePoints(int newForcePoints) {
		this.forcePoints = newForcePoints;
	}
	
	
	// Function for getting the owner if the actor is a droid
	...
	/**
	 * Sets the hit points of this <code>SWActor</code>.
	 * 
	 * @return 	the hit points of this <code>SWActor</code> 
	 * @see 	#hitpoints
	 * @see 	#isDead()
