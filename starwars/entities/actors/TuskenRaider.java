...
public class TuskenRaider extends SWActor {
	...
	// I never watched any StarWars movie, I guess there might be a version of TuskenRaider who has no Force abilities?
	public TuskenRaider(int hitpoints, String name, MessageRenderer m, SWWorld world) {
		super(Team.TUSKEN, 50, m, world);
		this.name = name;
	}
	
	public TuskenRaider(int hitpoints, String name, MessageRenderer m, SWWorld world, Integer ForcePoints) {
		super(Team.TUSKEN, 50, m, world, ForcePoints);
		this.name = name;
	}
