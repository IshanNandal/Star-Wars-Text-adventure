...
public class BenKenobi extends SWLegend {
	...
	private BenKenobi(MessageRenderer m, SWWorld world, Direction [] moves, Integer ForcePoints) {
		super(Team.GOOD, 1000, m, world, ForcePoints);
	...
	public static BenKenobi getBenKenobi(MessageRenderer m, SWWorld world, Direction [] moves, Integer ForcePoints) {
		ben = new BenKenobi(m, world, moves, ForcePoints);
		ben.activate();
		return ben;
	}
