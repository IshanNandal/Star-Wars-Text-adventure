...
public abstract class SWLegend extends SWActor {
	...
	// Suppose some legends have force ability, some don't...
	protected SWLegend(Team team, int hitpoints, MessageRenderer m, SWWorld world, Integer ForcePoints) {
		super(team, hitpoints, m, world, ForcePoints);
		isActivated = false;
	}
